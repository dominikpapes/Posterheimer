\chapter{Specifikacija programske potpore}
	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Sekvencijski dijagrami}
				...
				\begin{figure}
					\includegraphics[width=\linewidth]{Slike/UC_Upravljanje_digitalnim_posterima.png}
					\caption{Sekvencijski dijagram za UC18, UC19 i UC20}
				\end{figure}
				\begin{figure}
					\includegraphics[width=\linewidth]{Slike/Slanje_e-pošte.png}
					\caption{Sekvencijski dijagram za slanje elektroničke pošte korisnicima i autorima}
				\end{figure}
