			...
			\subsection{Obrasci uporabe}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_item}
							...
							\item[] \begin{packed_enum}
								\item U sustavu se briše korisnikovo prethodno glasovanje i registrira se novo
							\end{packed_enum}
						\end{packed_item}
					\end{packed_item}
