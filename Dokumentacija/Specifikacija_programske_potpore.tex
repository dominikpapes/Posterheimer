			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Opis obrazaca uporabe}
					...
					\begin{packed_item}
						...
						\end{packed_enum}
							...
							\item[] \begin{packed_item}
								...
								\item[4.] Administrator odlučuje ne obrisati korisnički račun
								\item[] \begin{packed_enum}			
									\item Otvara se popis korisničkih računa
								\end{packed_enum}
					...
					\begin{packed_item}
						...
						\item \textbf{Glavni sudionik: }Korisnik
						\item  \textbf{Cilj:} Pregledati galeriju postera
						\item  \textbf{Sudionici:} Baza podataka
						\item  \textbf{Preduvjet:} Korisnik je pristupio konferenciji
						\item  \textbf{Opis osnovnog tijeka:}
						...
						\item[] \begin{packed_enum}
							...
							\item[3.a] Prikazuje se uvećana verzija postera uz opće informacije o radu kojeg odabrani poster prikazuje (UC14)
							\item[3.b] Prikazuje se uvećana verzija prezentacije rada (UC30)
							\item[4.] Korisnik tijekom pregleda ima opciju glasanja za poster (UC15)
						\end{packed_enum}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik odabire opciju "Info" iz bočne trake stranice / Sve se nalazi na traci
						\end{packed_enum}
					\end{packed_item}
