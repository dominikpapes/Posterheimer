	...
	\section{Funkcionalni zahtjevi}
			...
			\begin{packed_enum}
				...
				\begin{packed_enum}
					...
					\item izbrisati postojeću konferenciju
					\item stvoriti administratora za konferenciju
				\end{packed_enum}
			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Opis obrazaca uporabe}
					...
					\noindent \underbar{\textbf{UC\theUseCaseCounter \stepcounter{UseCaseCounter} - Upravljanje konferencijama}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Natkorisnik se prijavljuje
							\item Otvara se obrazac za unos podataka o konferenciji i dodavanje administratora konferencije
							\item Otvara se prikaz galerije postera
							\item Natkorisnik se odjavljuje
						...
						\item[] \begin{packed_item}
							...
							\item[1.a] Natkorisnik odabire postojeću konferenciju
							\item[] \begin{packed_enum}
								
								\item Prikazuje se galerija postera
								
							\end{packed_enum}
							
							\item[5.a] Natkorisnik odabire opciju za brisanje trenutno otvorene konferencije
							\item[] \begin{packed_enum}
								
								\item Povratak na prozor za prijavu
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_item}
							...
							\item[1.a] Konferencija je završena
							\item[] \begin{packed_enum}			
								\item Posteri se prikazuju sortirani po rangu
							\end{packed_enum}
						\end{packed_item}	
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik odabire opciju za pregled osobnih podataka i obavijesti
							\item Aplikacija prikazuje osobne podatke korisnika i popis obavijesti
						\end{packed_enum}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Administrator odabire jednu od opcija za upravljanje posterima
							\item Izlazak iz sučelja za upravljanje posterima
						\end{packed_enum}
						...
						\item[] \begin{packed_item}
							...
							\item[2.a] Odabrana opcija za dodavanje postera
							\item[] \begin{packed_enum}
								
								\item Otvara se sučelje za unos podataka i lokalne datoteke
								\item Autor potvrđuje promjene
							\end{packed_enum}
							
							\item[2.b] Odabrana opcija za Brisanje postera
							\item[] \begin{packed_enum}
								
								\item Otvara se sučelje za brisanje postera
								\item Autor potvrđuje promjene
							\end{packed_enum}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Administrator pritiskom na gumb otvara posebno sučelje za upravljanje fotografijama
							\item Administrator odabire jednu od opcija za upravljanje fotografijama
							\item Izlazak iz sučelja za upravljanje fotografijama
						\end{packed_enum}
						...
						\item[] \begin{packed_item}
							...
							\item[2.a] Odabrana opcija za dodavanje fotografije
							\item[] \begin{packed_enum}
								
								\item Otvara se sučelje za odabir lokalne datoteke
								\item Autor potvrđuje promjene
							\end{packed_enum}
							
							\item[2.b] Odabrana opcija za brisanje fotografije
							\item[] \begin{packed_enum}
								
								\item Otvara se sučelje za brisanje fotografije
								\item Autor potvrđuje promjene
							\end{packed_enum}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Administrator pritiskom na gumb otvara posebno sučelje za upravljanje promotivnim materijalima
							\item Administrator odabire jednu od opcija za upravljanje promotivnim materijalima
							\item Izlazak iz sučelja za upravljanje promotivnim materijalima
						\end{packed_enum}
						...
						\item[] \begin{packed_item}
							...
							\item[2.a] Odabrana opcija za dodavanje promotivnih materijala
							\item[] \begin{packed_enum}
								
								\item Otvara se sučelje za unos podataka
								\item Autor potvrđuje promjene
							\end{packed_enum}
							
							\item[2.b] Odabrana opcija za brisanje promotivnog materijala
							\item[] \begin{packed_enum}
								
								\item Otvara se sučelje za brisanje promotivnog materijala
								\item Autor potvrđuje promjene
							\end{packed_enum}
					...
					\noindent \underbar{\textbf{UC\theUseCaseCounter \stepcounter{UseCaseCounter} - Slanje poruke e-pošte i prikaz notifikacije}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Šalje se obavijest u aplikaciju
						\end{packed_enum}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Slanje poruke e-pošte dohvaćenim e-adresama i obavijesti u aplikaciji
