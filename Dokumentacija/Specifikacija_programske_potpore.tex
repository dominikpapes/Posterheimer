	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Opis obrazaca uporabe}
					...
					\noindent \underbar{\textbf{UC\theUseCaseCounter \stepcounter{UseCaseCounter} - Izlaz iz pregleda fotografije s konferencije}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC\theUseCaseCounter \stepcounter{UseCaseCounter} - Izlazak iz pregleda digitalnog postera ili prezentacije}}
					\begin{packed_item}
						
						\item \textbf{Glavni sudionik: } Korisnik
						\item  \textbf{Cilj:} Izaći iz pregleda digitalnog postera ili prezentacije
						\item  \textbf{Sudionici:} Baza podataka
						\item  \textbf{Preduvjet:} Pregled digitalnog postera ili prezentacije
						\item  \textbf{Opis osnovnog tijeka:}
						
						\item[] \begin{packed_enum}
							
							\item Korisnik odabire opciju za izlazak iz pregleda
							\item Povratak na galeriju digitalnih postera
						\end{packed_enum}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Aplikacija se vraća na pregled galerije postera
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_item}
							...
							\item[4.a] Administrator odustaje od dodavanja fotografije
							\item[] \begin{packed_enum}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Administrator odabire opciju za spremanje promjena ili za odbacivanje promjena
							\item Ako je izabrana opcija za spremanje promjena, ažuriraj bazu podataka
							\item Povratak na sučelje za upravljanje fotografijama
						\end{packed_enum}
